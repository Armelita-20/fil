	...
	<div class="d-flex justify-content-center h-100">
		<div class="card">
            ...
            <div class="float-right">
                     ...
                     <a class="nav-link liens" href="{{ route('login') }}">Se connecter</a>
                    </div>
				<h3>Se connecter </h3>
            ...
            <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="input-group form-group">
                        ...
                        <input id="password-confirm" type="password" class="form-control" placeholder="confirmer votre mot de passe" name="password_confirmation" required autocomplete="new-password">

					</div>
                    
                    <div class="form-group">
						<input type="submit" value="S'identifier" class="btn float-right login_btn">
					</div>
				</form>
			</div>
